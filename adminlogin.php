...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['name']) && isset($_POST['password'])) {
        ...
        } elseif ($authenticationResult === 'success') {
            $_SESSION['name'] = $name;
            header("Location: http://localhost/RfidAttendence/adminpanel.php");
            exit();
        } else {
            echo '<script>alert("An error occurred during authentication. Please try again.");</script>';
        }
    }
}
...
<head>
    ...
    animation: slideIn 1s ease-in-out;
        ...
        h1 {
            color: black; /* Set title color to pink */
        }

        .btn-primary {
            background-color: black; /* Set button color to pink */
            border-color: black;
        }
        ...
        .btn-primary:hover {
            background-color: white; /* Change to the desired hover color */
            border-color: white; /* Change to the desired hover color */
...
<body>
    ...
    <div class="container">
        <h1 class="text-center mb-4"><b>ADMIN LOGIN</b></h1>

        <!-- Login Form -->
        <div class="form-container" id="loginForm">
            <!-- <h3 class="mb-3"><font color="black">Login</font></h3> -->
